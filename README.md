...
Проекты представлены в формате тетрадок iPython. Проекты были проверены наставниками Яндекс.Практикум.
...
<br></br>
	_Инструменты: Numpy, Pandas, Plotly, SciPy, statsmodels, Seaborn, Matplotlib_
